...
function puy(elem){
            document.getElementById("four").innerHTML = "PUYOL<br><br>Position: Defender<br><br>Games Started: 593<br><br>Goals: 18<br><br>Assists:44";
}
function sua(elem){
            document.getElementById("five").innerHTML = "SUAREZ<br><br>Position: Striker<br><br>Games Started: 192<br><br>Goals: 133<br><br>Assists:63";
}
function ney(elem){
...
function mes(elem){
	elem.classList.toggle("messi.png");
